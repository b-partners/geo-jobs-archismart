...
public record DelimitedPoints(
    ...
    Map<LidarClass, Integer> classifications) {
  public DelimitedPoints(
    ...
    this(
        ...
        points,
        new EnumMap<>(LidarClass.class));
  }

  public void incrementClassificationCount(LidarClass lidarClass) {
    classifications.merge(lidarClass, 1, Integer::sum);
  }
