...
class DetectionTilingRequestedServiceTest {
  ...
  void invokes_detection_tiling_creation() {
    ...
    doNothing().when(detectionSupportedModelValidatorMock).accept(detectionMock);
  ...
  @Test
  void produces_detection_model_unsupported_event() {
    var detectionIdentifier = randomUUID().toString();
    var detectionMock = mock(Detection.class);
    ...
    doThrow(new UnsupportedOperationException())
        .when(detectionSupportedModelValidatorMock)
        .accept(detectionMock);
    ...
    assertEquals(
        DetectionStep.builder()
            ...
            .build(),
        capturedDetectionStep);
    var actualDetectionModelUnsupported =
        (DetectionModelUnsupported) listCaptor.getValue().getFirst();
    assertEquals(
        new DetectionModelUnsupported(detectionIdentifier), actualDetectionModelUnsupported);
  }
}
